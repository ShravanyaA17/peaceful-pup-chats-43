  ...
  return (
    <div className="flex flex-col items-center justify-center py-8">
      ...
      <div className="relative mb-6">
        ...
        {/* Floating hearts */}
        <div className="absolute -top-8 -left-4 text-pink-400 animate-bounce" style={{ animationDelay: '0s' }}>
          <Heart className="w-3 h-3 fill-current" />
        </div>
        <div className="absolute -top-6 -right-4 text-pink-400 animate-bounce" style={{ animationDelay: '0.5s' }}>
          <Heart className="w-2 h-2 fill-current" />
        </div>
        <div className="absolute -top-10 left-8 text-pink-400 animate-bounce" style={{ animationDelay: '1s' }}>
