        ...
        <Card className="p-8 shadow-comfort border-peace-pink/20">
          <div className="text-center mb-8">
            ...
            <p className="text-peace-text-gentle leading-relaxed max-w-2xl mx-auto">
              Sometimes putting our thoughts on paper helps us understand what we're carrying. 
              Here are some gentle prompts to explore, or you can simply write whatever comes to mind.
            </p>
          </div>
          ...
          <div className="text-center space-y-4">
            ...
            <p className="text-sm text-peace-text-gentle max-w-md mx-auto">
              Your words are safe here. Write as much or as little as feels right. 
              You can answer one prompt, or just let your thoughts flow freely. 🌱
            </p>
          </div>
        </Card>
      </div>
