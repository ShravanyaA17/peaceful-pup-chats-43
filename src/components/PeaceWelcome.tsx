    ...
    <div className="min-h-screen bg-gradient-comfort flex items-center justify-center p-6">
      <Card className="max-w-2xl w-full p-8 text-center shadow-comfort border-peace-pink/20">
        ...
        <p className="text-lg text-peace-text-gentle mb-6 leading-relaxed">
          I'm here to help you when you're feeling anxious, overwhelmed, or
          just... not quite okay. Sometimes our hearts carry weight we can't
          name, and that's perfectly normal.
        </p>

        <p className="text-peace-text-gentle mb-8 leading-relaxed">
          Let's gently explore what might be affecting you today. I'll walk with
          you through some questions that might help us figure out what's going
          on inside. Take your time—there's no rush.
        </p>
